...
public class ExtratorDadosNota4Test {
	
	String textoNota = "";
	{
		try {
			textoNota = new String(Files.readAllBytes(Paths.get(ExtratorDadosNota4Test.class.getResource("/teste4.txt").getPath())));
		} catch (IOException e) {
			e.printStackTrace();
		}	
	...
	public void deve_extrair_coo_corretamente() {
		...
		Assert.assertTrue(StringUtils.equals(dadosNota.getCoo(), "324966"));
	}
	...
	public void deve_extrair_valor_total_corretamente() {
		...
		Assert.assertTrue(StringUtils.equals(dadosNota.getValorTotal(), "50,00"));
	}
	...
	public void deve_extrair_data_corretamente() {
		...
		Assert.assertTrue(StringUtils.equals(dadosNota.getData(), "12/08/2010"));
	}
